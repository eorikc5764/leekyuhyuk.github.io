...
![Operand]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/operand.jpg)  
...
- `MOV  R0, #0x7F00` : **가능**
![Example 1]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/example1.png)

- `MOV  R0, #0x30C0` : **가능**
![Example 2]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/example2.png)

- `MOV  R3, #0x14E` : **불가능**
![Example 3]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/example3.png)
...
![LDR, STR 쉽게 이해하는 방법]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/ldr_str_tip.png)
...
![Example 4]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/example4.png)
...
![CPSR - https://www.wikinote.org/Main/Savitribai-Phule-Pune-University/ENTC/AP-TE/Unit-1/Registers-CPSR-SPSR/]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/cpsr.jpg)
...
- `BL label` : Branch and Link
  ...
  ![Subroutine]({{ site.url }}/assets/image/2019-05-15-ARM-Assembly/subroutine.png)
